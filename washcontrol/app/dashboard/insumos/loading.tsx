  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex gap-2 border-b border-zinc-800 pb-0">
        <div className="h-10 w-40 bg-zinc-800 rounded-t-lg animate-pulse" />
        <div className="h-10 w-52 bg-zinc-800 rounded-t-lg animate-pulse" />
      </div>
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="flex items-center gap-4 px-5 py-3.5 border-b border-zinc-800/50 animate-pulse">
            <div className="w-8 h-8 rounded-lg bg-zinc-800" />
            <div className="flex-1 h-4 bg-zinc-800 rounded w-32" />
